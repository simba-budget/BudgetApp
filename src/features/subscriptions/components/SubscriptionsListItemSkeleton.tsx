...
export interface SubscriptionsListItemSkeletonProps {
  style?: StyleProp<ViewStyle>;
}

const SubscriptionsListItemSkeleton = ({
  style,
}: SubscriptionsListItemSkeletonProps) => (
...
export default SubscriptionsListItemSkeleton;
